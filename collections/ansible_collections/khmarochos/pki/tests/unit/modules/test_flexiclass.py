...
class Persistence(unittest.TestCase):
    ...
    def test_something(self):
        ...
        self.assertEqual(foo2.bravo, 'foo2-bravo')
        self.assertEqual(foo2.charlie, 'foo2-charlie')
        self.assertEqual(foo3.alpha, 'foo3-alpha-modified')
        self.assertEqual(foo3.bravo, 'foo3-bravo-modified')
        self.assertEqual(foo3.charlie, 'foo3-charlie-modified')
...
class PropertyBinding(unittest.TestCase):
    ...
    def test_property_binding(self):
        ...
        self.assertEqual(42, alpha.charlie_value)
        self.assertEqual(42, alpha.bravo.charlie_value)
        self.assertEqual(42, alpha.bravo.charlie.value)
        alpha.bravo.charlie.value = 13
        self.assertEqual(13, alpha.charlie_value)
        self.assertEqual(13, alpha.bravo.charlie_value)
        self.assertEqual(13, alpha.bravo.charlie.value)
